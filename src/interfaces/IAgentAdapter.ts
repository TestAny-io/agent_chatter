 ...
 *
 * @file src/interfaces/IAgentAdapter.ts
 *
 ...
 *
 * NOTE: Migrated from src/adapters/IAgentAdapter.ts for Core/CLI separation
 */

import type { IProcess } from './IExecutionEnvironment.js';
...
export interface AgentSpawnResult {
  /**
   * The spawned process (abstracted via IProcess)
   */
  process: IProcess;
  ...
  /**
   * Custom streams for monitoring
   * If provided, will listen to these instead of process.stdout/stderr
